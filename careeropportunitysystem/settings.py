...
SECRET_KEY = 'django-insecure-56mwqt_e^j69%^nu3d)0ncvwiet6%6f1u=+#yc@t@(eoyq^^ur'
...
ROOT_URLCONF = 'careeropportunitysystem.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'careeropportunitysystem_fresh',
        'USER': 'root',
        'PASSWORD': '', # Update this if @Root123_ was the correct one
        'HOST': '127.0.0.1',
        'PORT': '3306',
    }
}
